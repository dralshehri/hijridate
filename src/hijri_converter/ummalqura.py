...
month_starts: Reduced Julian Day (RJD) numbers for the beginning of
    ...
    the comparison calendar published by KFUPM Research Institute:
    https://www.staff.science.uu.nl/~gent0113/islam/downloads/ksa_calendar_1356_1411.pdf
    Years 1412-1500 AH were calculated by Mohammed Alshehri, based on
    his dataset for the official Umm al-Qura comparative calendars:
    https://github.com/dralshehri/ummalqura-calendar
"""

gregorian_range = (1937, 3, 14), (2077, 11, 16)
hijri_range = (1356, 1, 1), (1500, 12, 30)
hijri_offset = 1355 * 12
month_starts = (
    28607,
    28636,
    28665,
