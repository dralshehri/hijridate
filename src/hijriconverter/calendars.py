...
This module contains calendar constants used by ``convert`` module. In
addition to general constants, both Gregorian and Hijri
calendars have their own specific constants.
...
class Gregorian:
    """Gregorian calendar specific constants.
...
class Hijri:
    """Umm al-Qura Hijri calendar specific constants.
