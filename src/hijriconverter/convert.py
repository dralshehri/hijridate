...
class Hijri:
    ...
    The calendar argument is optional, default is 'lunar'.
    The validate argument is optional, default is True.
    """
    def __init__(self, year: int, month: int, day: int,
                 calendar: str = 'lunar', validate: bool = True) -> None:
        """Instantiate.  year, month, day are required arguments."""
        if validate:
    ...
    def isoformat(self) -> str:
        """Return date formatted according to ISO. That is YYYY-MM-DD."""
    ...
    def datetuple(self) -> Tuple[int, int, int]:
        """Return date tuple as (year, month, day)."""
    ...
    def month_name(self, language: str = 'en') -> str:
        """Return month name in specific language, English by default."""
    ...
    def day_name(self, language: str = 'en') -> str:
        """Return day name in specific language, English by default."""
...
class Gregorian:
    ...
    def to_hijri(self, calendar: str = 'lunar') -> Hijri:
        ...
        return Hijri(year, month, day, calendar, validate=False)
